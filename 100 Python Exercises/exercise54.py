...
On the left side of the assignment operator we are accessing
Smith  as we did in the previous exercise. Then using the assignment
operator we simply assign a new string to that item.
'''
