#Question:
'''
Create a program that ask the user to submit text
through a web appself.

Hint: You could use any web framework for this, but Flask is the easiest one.
'''
#Answer:
'''
